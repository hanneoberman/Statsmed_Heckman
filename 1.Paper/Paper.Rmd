...
Regarding the coverage, the 2l.Heckman imputation method provides the best coverage values across all the $\rho$ scenarios with a coverage level close to the nominal 95\% interval. Even 2l.Heckman is not properly a randomization-valid (Rubin 1987b) method across all the $\rho$ values it leads to better results in terms of bias and coverage compared to the evaluated methods.  
