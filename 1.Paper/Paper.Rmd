...
We calculated the following evaluation criteria [@VanBureen] according to the formulas provided in Morris et al.(2019)[@morris2019]:
...
-\testbf{Width}: Width of the confidence interval on the coefficient parameters.
